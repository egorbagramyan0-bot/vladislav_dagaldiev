      ...
      <div className="container quiz-container">
        ...
        <div className="quiz-form-card reveal-element">
          {!submitted ? (
            ...
            <div className="quiz-success-container animate-step">
              <div className="success-icon-wrapper">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="success-svg">
                  <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" strokeLinecap="round" strokeLinejoin="round" />
                  <polyline points="22 4 12 14.01 9 11.01" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <h3 className="success-title">Заявка успешно отправлена</h3>
              <p className="success-desc">
                Спасибо за ответы. В ближайшее время я свяжусь с вами и помогу подобрать оптимальный формат для вашего мероприятия.
              </p>
            </div>
          )}
        </div>
